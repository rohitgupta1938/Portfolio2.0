...
function Profile() {
  return (
    <section
      id="profile"
      className="relative min-h-screen bg-gray-950 text-white py-20 px-6 md:px-12 flex flex-col items-center overflow-hidden"
    >
      ...
      <motion.h2
        ...
        className="text-4xl font-bold mb-16 z-10 text-center"
      >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl w-full relative z-10">
        ...
        >
          ...
          <p className="text-gray-300 mt-3 text-center lg:text-left">
            ...
            skilled in React, Node.js, and problem solving. Passionate about
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block bg-emerald-500/10 border border-emerald-400/20 p-4 rounded-lg text-center hover:bg-emerald-500/20 transition font-semibold text-amber-300"
                >
                  {platform.name}
                </a>
              ))}
