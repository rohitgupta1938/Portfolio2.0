...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative min-h-screen  items-center justify-center px-4 sm:px-6 md:px-12 lg:px-20 py-12 md:py-16 bg-gray-950 text-white"
    >
      <h2 className="text-4xl font-bold text-center relative z-10 hidden md:block">
      ...
      <div className="relative z-10 pt-5 max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
        ...
        Send Me a <span className="text-amber-400">Message</span>
         ...
         <form
          ...
          method="POST"
          className="bg-gray-900 rounded-2xl mt-5 shadow-xl space-y-4 sm:space-y-5 p-4 sm:p-6 md:p-8"
        >
          <input
            type="text"
            name="name"
